 ...
 */
package com.mycompany.copiar02;
 ...
 * @author Usuario
 */
public class copiar02 extends javax.swing.JFrame {

    /**
     * Creates new form copiar02
     */
    public copiar02() {
        initComponents();
    }
    ...
    private void BotonCopiaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonCopiaActionPerformed
        ...
        try {
            ...
            Logger.getLogger(copiar02.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(copiar02.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
