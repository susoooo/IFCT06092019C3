...
Person::~Person() {
  if (strcmp(this->name,"") == 0)
    std::cout << "Some being" << " has left the building, after born in " << this->bornDate.day << "/" << this->bornDate.month << "/" << this->bornDate.year << std::endl;
  else
    std::cout << this->name << " has left the building, after born in " << this->bornDate.day << "/" << this->bornDate.month << "/" << this->bornDate.year << std::endl;
}
